...
function BusinessCard({ business }: { business: Business }) {
  return (
    <Link
      ...
      className="border-2 rounded-lg relative transition-shadow duration-300 hover:shadow-xl bg-white"
    >
      <img
        src={business.cover}
        alt={business.name}
      ...
      />
      <div className="p-4">
        <Avatar src={business.avatar} alt={business.name} className="-mt-14" />
        <p className="text-lg font-semibold mt-2 truncate">{business.name}</p>
